...
public:
    ...
    std::pair<double, double> DrawGraph(std::optional<std::string> ouput_file = std::nullopt);
...
std::pair<double, double> Energy::DrawGraph(std::optional<std::string> ouput_file)
{
